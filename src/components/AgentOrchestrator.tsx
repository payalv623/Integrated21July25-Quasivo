  ...
  return (
    <div className="relative mb-16">
      ...
      <div className="relative group">
        ...
        <div className="relative bg-black/40 backdrop-blur-sm border border-cyan-400/30 rounded-2xl p-8 hover:border-cyan-400/50 transition-all duration-300">
          ...
          <h3 className="text-xl font-semibold text-cyan-300 text-center mb-2">
            Central Orchestrator
          </h3>
          <p className="text-cyan-300/70 text-center text-sm">
            Coordinating all autonomous agents
          </p>
